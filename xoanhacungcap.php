	...
	if(isset($_POST["xoanhacc"]))
	{
		...
		function ktncc($mancc1){
			...
			if(ktncc($mancc,$data)==false)
				...
				$query=	"Delete From nhacungcap Where mancc like :mancc";
				$data=$loai->queryXoancc($query,$mancc);
				?>
				<script type="text/javascript">
...
<div class="container">
      ...
      <form class="form-dk" action="xoanhacungcap.php" method="post">
        <h2 class="form-signin-heading">Xóa Nhà Cung Cấp</h2>
        ...
        <input type="text" id="lydo" class="form-control" name="lydo" placeholder="Lý do" required autofocus>
        <button class="btn btn-lg btn-primary btn-block" name="xoanhacc" type="submit">Xóa Nhà Cung Cấp</button>
      </form>
