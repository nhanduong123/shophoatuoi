...
class cart extends db{
	...
	*/
	...
	public function hoaExist($hoa_id)
	{
		$sql="select * from sanpham where Masp = '$hoa_id' ";
		$temp = new db();
		$temp->exeQuery($sql);
	...
	{	
		...
		echo "<script language=javascript>window.location='thanhvien.php';</script>";//Chuyển trình duyệt web tới trang hiển thị cart
	}
