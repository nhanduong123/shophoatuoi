	...
	if(isset($_POST["xoasanpham"]))
	{
		...
		function ktsp($masp1){
			...
			if(ktsp($masp,$data)==false)
				...
				$query=	"Delete From sanpham Where masp like :masp";
				$data=$loai->queryXoasp($query,$masp);
				?>
				<script type="text/javascript">
...
<div class="container">
      ...
      <form class="form-dk" action="xoasanpham.php" method="post">
        <h2 class="form-signin-heading">Xóa Sản Phẩm</h2>
        ...
        <button class="btn btn-lg btn-primary btn-block" name="xoasanpham" type="submit">Xóa Sản Phẩm</button>
      </form>
