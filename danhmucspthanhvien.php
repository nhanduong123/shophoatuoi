  						...
  						<div class="panel-heading">
    						<div class="panel-body">
     						 	<div  class="panel-footer">
        							<div class="panel-heading"><a href="./sanphamthanhvien.php?id=<?php echo $row["Masp"]; ?>"><?php echo $row["Tensp"]; ?></a></div>
        							<div class="panel-body"><a href="./sanphamthanhvien.php?id=<?php echo $row["Masp"]; ?>"><img src="<?php echo $row["Hinhanh"]; ?>" class="img-responsive"></a></div>
       								 <div class="panel-footer" align="center"> 
                                     
                                     	<div><a href="#"><?php echo $row["Dongia"]; ?> VND</a></div>
                                     	<div> <button type="button" class="btn btn-danger"><a href="#"></a>Đặt Mua</button></div>
                                        </div>
      							</div>
    						</div>
               			 </div>
