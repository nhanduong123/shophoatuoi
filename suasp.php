<?php
	...
	{
		$tensp;$mota;$hinhanh;$soluong;$dongia;
		...
		if (isset($_POST["dongia"]))
			$dongia = $_POST["dongia"];
		$query=	"update sanpham set Tensp=tensp,Mota=mota,Soluong=soluong,Dongia=dongia where Masp=$ma";
		$data=$loai->querySuasp($query,$tensp,$mota,$soluong,$dongia);
				?>
...
<div class="container">
      ...
      <form class="form-dk" action="suasp.php" method="post">
        <h2 class="form-signin-heading">Sửa Sản Phẩm</h2>
        ...
        <button class="btn btn-lg btn-primary btn-block" name="suasp" type="submit">Sửa Sản Phẩm</button>
      </form>
